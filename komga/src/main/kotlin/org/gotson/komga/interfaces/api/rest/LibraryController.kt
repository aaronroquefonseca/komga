      ...
      libraryLifecycle
        .addLibrary(
          Library(
            ...
            defaultReadingDirection = library.defaultReadingDirection,
      ...
      val toUpdate =
        with(library) {
          existing.copy(
            ...
            defaultReadingDirection = if (isSet("defaultReadingDirection")) defaultReadingDirection else existing.defaultReadingDirection,
