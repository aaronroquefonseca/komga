...
i18n.mergeLocaleMessage('en', {
  ...
  offline: {
    ...
    notification_permission: 'Browser permission: {status}',
    test_notification: 'Send test notification',
    test_notification_sent: 'Test notification was handed to the browser.',
    test_notification_failed: 'The browser did not accept the test notification.',
